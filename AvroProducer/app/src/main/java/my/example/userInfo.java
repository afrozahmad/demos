...
public class userInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private my.example.mailing_address address;
   ...
   */
  public userInfo(java.lang.CharSequence username, java.lang.Integer age, java.lang.CharSequence phone, java.lang.CharSequence housenum, my.example.mailing_address address) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: address = (my.example.mailing_address)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public my.example.mailing_address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(my.example.mailing_address value) {
    this.address = value;
  }
   ...
   */
  public static my.example.userInfo.Builder newBuilder() {
    return new my.example.userInfo.Builder();
  }
   ...
   * @return A new userInfo RecordBuilder
   */
  public static my.example.userInfo.Builder newBuilder(my.example.userInfo.Builder other) {
    if (other == null) {
      return new my.example.userInfo.Builder();
    } else {
      return new my.example.userInfo.Builder(other);
    }
  }
   ...
   * @return A new userInfo RecordBuilder
   */
  public static my.example.userInfo.Builder newBuilder(my.example.userInfo other) {
    if (other == null) {
      return new my.example.userInfo.Builder();
    } else {
      return new my.example.userInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<userInfo>
    ...
    private java.lang.CharSequence housenum;
    private my.example.mailing_address address;
    private my.example.mailing_address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(my.example.userInfo.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = my.example.mailing_address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(my.example.userInfo other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder setPhone(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder clearPhone() {
      phone = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder setHousenum(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder clearHousenum() {
      housenum = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder setAddress(my.example.mailing_address value) {
     ...
     * @return This builder.
     */
    public my.example.mailing_address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(my.example.mailing_address.newBuilder(address));
        } else {
          setAddressBuilder(my.example.mailing_address.newBuilder());
        }
      }
    ...
    public my.example.userInfo.Builder setAddressBuilder(my.example.mailing_address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public my.example.userInfo.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public userInfo build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[4] ? this.address : (my.example.mailing_address) defaultValue(fields()[4]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new my.example.mailing_address();
      }
